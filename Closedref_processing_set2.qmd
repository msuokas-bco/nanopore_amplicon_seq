...
Dereplication removes unncessary redundancy from sequence files
...
```{r, size="small", eval=F}
taxa <- assignTaxonomy(referenceSeq(tse), refFasta = "~/feature_classifiers/silva_nr99_v138.1_train_set.fa.gz", minBoot=90, multithread =2, verbose=T)
